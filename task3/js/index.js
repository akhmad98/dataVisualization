...
var grpXAxs = chart.append("g")
      .attr("transform", `translate(0, ${svgHeight})`);
var grpYAxs = chart.append("g");
...
chart.append("g")
      ...
      .attr("transform", `translate (0, ${svgHeight})`)
      .style("color", "#d3d3d3")
      .call(x_gride(xScale).tickSize(-svgHeight).tickFormat(""));
chart.append("g")
      .attr("class", "yAxis")
      .attr("fill", "none")
      .style("color", "#d3d3d3")
      .call(y_gride(yScale).tickSize(-svgWidth).tickFormat(""))
 
      var tooltip = d3.select("body").append("div").attr("id", "tool-tip");
